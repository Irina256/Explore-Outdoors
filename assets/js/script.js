...
var preparedQuestion = function () {
    ...
    for (var i = 0; i < questChoiPoints[questionTracker].choices.length; i++) {
        ...
        listItem.className = "value col s12 btn-large";
...
$(document).on('click', '.value', function (e) {
    ...
    if (answerChoice === questChoiPoints[questionTracker].choices[answerTracker]) {
        ...
        honoluluScore += (questChoiPoints[questionTracker].points[0].firstChoice[5]);
        ...
        honoluluScore += (questChoiPoints[questionTracker].points[0].secondChoice[5]);
        ...
        honoluluScore += (questChoiPoints[questionTracker].points[0].thirdChoice[5]);
        ...
        honoluluScore += (questChoiPoints[questionTracker].points[0].fourthChoice[5]);
    }
    ...
    if (questionTracker < questChoiPoints.length - 1) {
        ...
        scoreReport(parisScore, romeScore, londonScore, miamiScore, orlandoScore, honoluluScore);
    }
});

var askQuestion = document.querySelector("#startQuiz");
askQuestion.addEventListener("click", preparedQuestion);
var scoreReport = function (parisScore, romeScore, londonScore, miamiScore, orlandoScore, honoluluScore) {
